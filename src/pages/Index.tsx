        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
          ...
          <ScrollAnimator delay={200}>
            <div className="flex flex-col items-center lg:items-end gap-4">
              ...
              <div className="mt-10 inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-card text-sm font-medium font-display text-foreground transition-colors duration-200 badge-shine">
