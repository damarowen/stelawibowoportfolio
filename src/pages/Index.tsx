    ...
    <div className="space-y-32 pb-20">
      ...
      <section>
        ...
        <div className="flex items-center justify-end gap-3 mb-4">
          <button onClick={() => scrollProjectTo("left")} className="p-2.5 rounded-full bg-primary/20 border border-primary/40 text-foreground hover:bg-primary/30 hover:border-primary/60 transition-all">
            <ChevronLeft className="w-5 h-5" />
          </button>
          <button onClick={() => scrollProjectTo("right")} className="p-2.5 rounded-full bg-primary/20 border border-primary/40 text-foreground hover:bg-primary/30 hover:border-primary/60 transition-all">
