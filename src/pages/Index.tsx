        ...
        <ScrollAnimator delay={100}>
          <div className="bg-card rounded-2xl border border-border p-6 md:p-8 space-y-5">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="https://www.upwork.com/freelancers/~013c524c90b5b3db06" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-secondary border border-border text-foreground text-sm font-medium hover:navy-glow transition-all duration-200">
              ...
              <a href="https://www.freelancer.com/u/stelawibowo?frm=stelawibowo&sb=t" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-secondary border border-border text-foreground text-sm font-medium hover:navy-glow transition-all duration-200">
